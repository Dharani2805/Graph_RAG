from transformers import AutoModelForSeq2SeqLM, AutoTokenizer, AutoModel,AutoModelForCausalLM, AutoTokenizer
...
rdf_model = AutoModelForCausalLM.from_pretrained("mistralai/Mistral-7B-v0.1")
